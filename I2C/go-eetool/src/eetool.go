...
// NOTE: "ARCH_" is added in automatically by maestro
var sslCerts = []certs_anatomy {
    ...
    certs_anatomy { "CA_CERT_PEM", "/mnt/.boot/.ssl/ca.cert.pem", ""},
    certs_anatomy { "INTERMEDIATE_CERT_PEM", "/mnt/.boot/.ssl/intermediate.cert.pem", ""},
    certs_anatomy { "CA_CHAIN_CERT_PEM", "/mnt/.boot/.ssl/ca.cert.pem", "/mnt/.boot/.ssl/intermediate.cert.pem"},
}
...
var metadata = []eeprom_anatomy {
    ...
    eeprom_anatomy {"_IXLBR_MAC",        0x50, 31, 8  },
